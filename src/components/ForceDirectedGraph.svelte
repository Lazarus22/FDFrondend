...
// Event listeners for simulation updates (tick)
simulation.on("tick", () => {
  // Update your nodes and links here
  // For example, if you're using SVG circles for nodes:
  node.attr("cx", d => d.x)
      .attr("cy", d => d.y);

  // And if you're using SVG lines for links:
